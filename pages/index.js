    ...
    <div className={styles.home}>
          ...
          <div className={styles.right}>
            ...
            <div className={styles.speaker}>
              ...
              <div className={styles.speakerRight}>
                ...
                <div className={styles.company}>{featuredWebinar?.company}</div>
              </div>
            </div>
            <div className={styles.register}>
              <button
                onClick={() => router.push(`webinars/${featuredWebinar?.slug}`)}
      ...
      */}
      <div className={styles.subscribe}>
        <div className={styles.title}>We are online Join the Conversation</div>
